  ...
  return (
    <div className="group rounded-3xl bg-[#fafafa] border border-gray-100 dark:shadow-none  dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-xl shadow-gray-600/10 rounded-t-xl ">
      ...
      <div className="relative p-8">
        ...
        <button
          onClick={openDialog}
          className="flex items-center justify-center w-full group-hover:text-green-700 text-black dark:text-white font-semibold mt-4 transition"
        >
        ...
        <section className="fixed inset-0 z-50  items-center justify-center bg-black bg-opacity-50 flex flex-col ">
          <article className="relative h-full w-full max-w-xl  bg-white dark:bg-gray-800 rounded-xl overflow-y-scroll max-h-[99%]  border border-gray-100 dark:shadow-none dark:border-gray-700">
            <div className="relative overflow-hidden rounded-t-xl ">
              <button
                onClick={closeDialog}
                className="w-fit fixed sm:top-0 top-1 right-0 p-2 bg-black rounded-xl rounded-e-none rounded-t-none hover:scale-105  transition duration-300 z-[100]"
              >
